...
data class PileUp(
    ...
    // Pile-up values in chromosome. Pile-up values are represented as a map of base pair indexes to counts
...
fun pileUpSam(samPath: Path, strand: Strand, atacMode: Boolean, pileUpAlgorithm: PileUpAlgorithm): Map<String, PileUp> {
    ...
    val values = mutableMapOf<String, MutableMap<Int, Int>>()
    ...
    samReader.use { reader ->
        reader.forEach { record ->
            ...
            values.putIfAbsent(chr, mutableMapOf())
